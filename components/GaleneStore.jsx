...
const PRODUTOS = [
  ...
  { id: 1,  nome: "Vestido Bella",       cat: "Vestidos",  sub: "Viscolaycra", preco: 40, destaque: true,  tag: "Mais Vendido", cores: ["Preto","Branco","Vinho","Nude","Marinho"],        tamanhos: SIZES_PADRAO, desc: "Vestido básico em viscolaycra com caimento elegante." },
  ...
  { id: 5,  nome: "Vestido Safira",      cat: "Vestidos",  sub: "Viscolaycra", preco: 60, destaque: true,  tag: "Novo",         cores: ["Marinho","Vinho","Preto","Grafite"],                tamanhos: SIZES_PADRAO, desc: "Modelagem sofisticada para uso day to night." },
  ...
  { id: 8,  nome: "Vestido Ariel",       cat: "Vestidos",  sub: "Viscolaycra", preco: 70, destaque: true,  tag: "Destaque",     cores: ["Azul","Verde","Coral","Preto"],                     tamanhos: SIZES_PADRAO, desc: "Vestido vibrante com modelagem contemporânea." },
  { id: 9,  nome: "Vestido Nina",        cat: "Vestidos",  sub: "Viscolaycra", preco: 85, destaque: true,  tag: "Premium",      cores: ["Preto","Marinho","Grafite","Vinho"],                tamanhos: SIZES_PLUS,   desc: "Linha premium com acabamento refinado." },
  { id: 10, nome: "Vestido Lola",        cat: "Vestidos",  sub: "Viscolaycra", preco: 70, destaque: false, tag: null,           cores: ["Nude","Rosa","Caramelo","Branco"],                  tamanhos: SIZES_PADRAO, desc: "Vestido feminino com tecido macio e confortável." },
  ...
  { id: 12, nome: "Vestido Laila",       cat: "Vestidos",  sub: "Viscolaycra", preco: 70, destaque: false, tag: null,           cores: ["Verde","Musgo","Preto","Nude"],                     tamanhos: SIZES_PADRAO, desc: "Inspiração natural com corte anatômico." },
  ...
  { id: 14, nome: "Vestido Marina",      cat: "Vestidos",  sub: "Viscolaycra", preco: 65, destaque: false, tag: null,           cores: ["Azul","Marinho","Jeans","Cinza"],                   tamanhos: SIZES_PADRAO, desc: "Estilo náutico com corte moderno." },
  { id: 15, nome: "Vestido Pandora",     cat: "Vestidos",  sub: "Viscolaycra", preco: 65, destaque: false, tag: null,           cores: ["Preto","Vinho","Lilás","Cinza"],                    tamanhos: SIZES_PADRAO, desc: "Tecido elástico de alta recuperação." },
  { id: 16, nome: "Vestido Itália",      cat: "Vestidos",  sub: "Viscolaycra", preco: 60, destaque: false, tag: null,           cores: ["Bege","Nude","Off White","Rosa"],                   tamanhos: SIZES_PADRAO, desc: "Inspirado na moda mediterrânea." },
  ...
  { id: 18, nome: "Vestido Brisa",       cat: "Vestidos",  sub: "Viscolaycra", preco: 40, destaque: false, tag: null,           cores: ["Off White","Azul","Rosa","Verde"],                  tamanhos: SIZES_PADRAO, desc: "Leve como uma brisa, conforto o dia todo." },
  { id: 19, nome: "Vestido Luana",       cat: "Vestidos",  sub: "Viscolaycra", preco: 40, destaque: false, tag: null,           cores: ["Preto","Bege","Caramelo"],                          tamanhos: SIZES_PADRAO, desc: "Básico essencial para o dia a dia." },
  { id: 20, nome: "Vestido Elisa",       cat: "Vestidos",  sub: "Viscolaycra", preco: 60, destaque: false, tag: null,           cores: ["Rosa","Nude","Vinho","Lilás"],                      tamanhos: SIZES_PADRAO, desc: "Feminino e elegante para qualquer ocasião." },
  ...
  // MOLETINHO
  { id: 22, nome: "Vestido Mônica Mol.", cat: "Moletinho", sub: "Moletinho",   preco: 75, destaque: true,  tag: "Novo",         cores: ["Preto","Cinza","Bege","Marinho"],                   tamanhos: SIZES_PADRAO, desc: "Moletinho premium com caimento relaxado e elegante." },
  { id: 23, nome: "Vestido Pandora Mol.",cat: "Moletinho", sub: "Moletinho",   preco: 85, destaque: false, tag: null,           cores: ["Preto","Grafite","Cinza","Musgo"],                  tamanhos: SIZES_PADRAO, desc: "Macio e confortável, perfeito para o dia a dia." },
  { id: 24, nome: "Vestido Itália Mol.", cat: "Moletinho", sub: "Moletinho",   preco: 75, destaque: false, tag: null,           cores: ["Bege","Caramelo","Off White","Marrom"],             tamanhos: SIZES_PADRAO, desc: "Estilo italiano em tecido moletinho premium." },
  // LANZINHA
  { id: 25, nome: "Vestido Itália Lanz.",cat: "Lanzinha",  sub: "Lanzinha",    preco: 60, destaque: false, tag: null,           cores: ["Bege","Nude","Off White","Cinza"],                  tamanhos: SIZES_PADRAO, desc: "Lanzinha de alta qualidade com caimento suave." },
  { id: 26, nome: "Vestido Mônica Lanz.",cat: "Lanzinha",  sub: "Lanzinha",    preco: 60, destaque: false, tag: null,           cores: ["Preto","Marinho","Grafite"],                        tamanhos: SIZES_PADRAO, desc: "Modelagem moderna em lanzinha premium." },
  { id: 27, nome: "Vestido Monica Lanz.",cat: "Lanzinha",  sub: "Lanzinha",    preco: 60, destaque: false, tag: null,           cores: ["Rosa","Lilás","Coral","Nude"],                      tamanhos: SIZES_PADRAO, desc: "Cores pastel delicadas em tecido lanzinha." },
  // CONJUNTOS
  { id: 2,  nome: "Conjunto Dallas",    cat: "Conjuntos", sub: "Viscolaycra", preco: 75, destaque: true,  tag: "Mais Vendido", cores: ["Preto","Nude","Marinho","Caramelo"],                tamanhos: SIZES_PADRAO, desc: "Conjunto cropped + saia com caimento impecável." },
  { id: 28, nome: "Conjunto Dani",      cat: "Conjuntos", sub: "Viscolaycra", preco: 85, destaque: true,  tag: "Premium",      cores: ["Preto","Vinho","Grafite","Marinho"],                tamanhos: SIZES_PADRAO, desc: "Conjunto sofisticado para ocasiões especiais." },
  { id: 29, nome: "Conjunto Tiffany",   cat: "Conjuntos", sub: "Viscolaycra", preco: 50, destaque: false, tag: null,           cores: ["Nude","Rosa","Bege","Off White"],                   tamanhos: SIZES_PADRAO, desc: "Delicado e feminino, ideal para o dia a dia." },
  ...
  { id: 31, nome: "Conj. Chantal Calça",cat: "Conjuntos", sub: "Viscolaycra", preco: 80, destaque: false, tag: null,           cores: ["Preto","Marinho","Grafite","Vinho"],                tamanhos: SIZES_PADRAO, desc: "Calça + blusa com tecido de alta qualidade." },
  { id: 32, nome: "Conjunto Chantal",   cat: "Conjuntos", sub: "Viscolaycra", preco: 80, destaque: false, tag: null,           cores: ["Nude","Bege","Caramelo","Rosa"],                    tamanhos: SIZES_PADRAO, desc: "Elegância cotidiana em viscolaycra premium." },
  // BLUSAS
  { id: 33, nome: "Blusa Caja",         cat: "Blusas",    sub: "Viscolaycra", preco: 35, destaque: false, tag: null,           cores: ["Preto","Branco","Nude","Cinza","Azul"],             tamanhos: SIZES_PADRAO, desc: "Blusa versátil para compor looks variados." },
  ...
  { id: 35, nome: "Blusa Julia",        cat: "Blusas",    sub: "Viscolaycra", preco: 45, destaque: true,  tag: "Novo",         cores: ["Branco","Off White","Nude","Rosa"],                 tamanhos: SIZES_PADRAO, desc: "Blusa premium com detalhes delicados." },
  { id: 36, nome: "Blusa Yasmin",       cat: "Blusas",    sub: "Viscolaycra", preco: 30, destaque: false, tag: null,           cores: ["Colorido","Coral","Azul","Verde","Amarelo"],        tamanhos: SIZES_PADRAO, desc: "Estampas vibrantes para looks descontraídos." },
  // REGATAS
  { id: 37, nome: "Regata Ellen",       cat: "Regatas",   sub: "Viscolaycra", preco: 20, destaque: false, tag: null,           cores: ["Preto","Branco","Nude","Cinza","Rosa","Azul"],      tamanhos: SIZES_PADRAO, desc: "Regata básica em viscolaycra — essencial no guarda-roupa." },
  // CARDIGANS
  { id: 38, nome: "Cardigan Canelado",  cat: "Cardigans", sub: "Canelado",    preco: 39, destaque: false, tag: null,           cores: ["Preto","Bege","Caramelo","Cinza","Off White"],      tamanhos: SIZES_UNICO,  desc: "Cardigan canelado com textura premium." },
  ...
  // CALÇAS
  { id: 40, nome: "Calça Pantalona",    cat: "Calças",    sub: "Viscolaycra", preco: 40, destaque: false, tag: null,           cores: ["Preto","Marinho","Caramelo","Bege","Cinza"],        tamanhos: SIZES_PADRAO, desc: "Pantalona fluida com cós elástico confortável." },
  // MACACÕES
  { id: 3,  nome: "Macacão Kami",       cat: "Macacões",  sub: "Viscolaycra", preco: 79, destaque: true,  tag: "Destaque",     cores: ["Preto","Nude","Caramelo","Marinho","Vinho"],        tamanhos: SIZES_PADRAO, desc: "Macacão elegante para looks completos e sofisticados." },
];
            ...
            <div style={{ background: T.bg, border: `1px solid ${T.border}`, borderRadius: 12, marginBottom: 14, overflow: "hidden" }}>
              ...
              {sel.map((s) => (
                <div key={s.key} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", borderBottom: `1px solid ${T.border}` }}>
                  ...
                  <button onClick={() => remS(s.key)} aria-label="Remover" style={{ background: "none", border: "none", cursor: "pointer", color: T.ink4, fontSize: 16, padding: 2 }}>✕</button>
                </div>
              ))}
...
const Carrinho = ({ cart, onRemove, onFinish, onBack }) => {
  ...
  if (ok) return (
    <div style={{ textAlign: "center", padding: "80px 24px" }}>
      <div style={{ width: 72, height: 72, background: `linear-gradient(135deg,${T.goldDk},${T.gold})`, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 24px", fontSize: 32 }}>✓</div>
                    ...
                    <div key={idx} style={{ background: T.panel, border: `1px solid ${T.border}`, borderRadius: 12, marginBottom: 12, overflow: "hidden" }}>
                      <div style={{ display: "flex", gap: 14, padding: "14px 16px" }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontFamily: "'Lato',sans-serif", fontSize: 10, color: T.ink4, marginTop: 2 }}>{item.cat} · {fmt(item.preco)}/pç</div>
                        </div>
            ...
            <div>
              ...
              {met === "cartao" && (
                <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr", gap: 12 }}>
                  {[["Número do Cartão", "2"], ["Nome no Cartão", "2"], ["Validade", "1"], ["CVV", "1"]].map(([l, c]) => (
