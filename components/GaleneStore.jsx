...
{ id: 1, nome: "Vestido Bella", cat: "Vestidos", sub: "Viscolaycra", preco: 40, destaque: t
{ id: 4, nome: "Vestido Eva", cat: "Vestidos", sub: "Viscolaycra", preco: 40, destaque: fal
{ id: 5, nome: "Vestido Safira", cat: "Vestidos", sub: "Viscolaycra", preco: 60, destaque:
{ id: 6, nome: "Vestido Naomi", cat: "Vestidos", sub: "Viscolaycra", preco: 70, destaque: f
{ id: 7, nome: "Vestido Mara", cat: "Vestidos", sub: "Viscolaycra", preco: 68, destaque: fa
{ id: 8, nome: "Vestido Ariel", cat: "Vestidos", sub: "Viscolaycra", preco: 70, destaque: f
{ id: 9, nome: "Vestido Nina", cat: "Vestidos", sub: "Viscolaycra", preco: 85, destaque: fa
{ id: 10, nome: "Vestido Lola", cat: "Vestidos", sub: "Viscolaycra", preco: 70, destaque: f
{ id: 11, nome: "Vestido Lorena ML", cat: "Vestidos", sub: "Viscolaycra", preco: 70, destaq
{ id: 12, nome: "Vestido Laila", cat: "Vestidos", sub: "Viscolaycra", preco: 70, destaque:
{ id: 13, nome: "Vestido Kenya", cat: "Vestidos", sub: "Viscolaycra", preco: 65, destaque:
{ id: 14, nome: "Vestido Marina", cat: "Vestidos", sub: "Viscolaycra", preco: 65, destaque:
{ id: 15, nome: "Vestido Pandora", cat: "Vestidos", sub: "Viscolaycra", preco: 65, destaque
{ id: 16, nome: "Vestido Italia", cat: "Vestidos", sub: "Viscolaycra", preco: 60, destaque:
{ id: 17, nome: "Vestido Allegra", cat: "Vestidos", sub: "Viscolaycra", preco: 65, destaque
{ id: 18, nome: "Vestido Brisa", cat: "Vestidos", sub: "Viscolaycra", preco: 40, destaque:
{ id: 19, nome: "Vestido Luana", cat: "Vestidos", sub: "Viscolaycra", preco: 40, destaque:
{ id: 20, nome: "Vestido Elisa", cat: "Vestidos", sub: "Viscolaycra", preco: 60, destaque:
{ id: 21, nome: "Vestido Aurora", cat: "Vestidos", sub: "Viscolaycra", preco: 40, destaque:
// MOLETINHO
{ id: 22, nome: "Vestido Monica Mol.", cat: "Moletinho", sub: "Moletinho", preco: 75, desta
{ id: 23, nome: "Vestido Pandora Mol.", cat: "Moletinho", sub: "Moletinho", preco: 85, dest
{ id: 24, nome: "Vestido Italia Mol.", cat: "Moletinho", sub: "Moletinho", preco: 75, desta
// LANZINHA
{ id: 25, nome: "Vestido Italia Lanz.", cat: "Lanzinha", sub: "Lanzinha", preco: 60, { id: 26, nome: "Vestido Monica Lanz.", cat: "Lanzinha", sub: "Lanzinha", preco: 60, { id: 27, nome: "Vestido Monica Lanz. Rosa", cat: "Lanzinha", sub: "Lanzinha", preco: 60, d
// CONJUNTOS
...
{ id: 29, nome: "Conjunto Tiffany", cat: "Conjuntos", sub: "Viscolaycra", preco: 50, destaq
{ id: 30, nome: "Conj. Tiffany Mol.", cat: "Conjuntos", sub: "Moletinho", preco: 98, destaq
{ id: 31, nome: "Conj. Chantal Calca", cat: "Conjuntos", sub: "Viscolaycra", preco: 80, des
{ id: 32, nome: "Conjunto Chantal", cat: "Conjuntos", sub: "Viscolaycra", preco: 80, destaq
// BLUSAS
{ id: 33, nome: "Blusa Caja", cat: "Blusas", sub: "Viscolaycra", preco: 35, destaque: false
{ id: 34, nome: "Blusa Bagda", cat: "Blusas", sub: "Viscolaycra", preco: 39, destaque: fals
{ id: 35, nome: "Blusa Julia", cat: "Blusas", sub: "Viscolaycra", preco: 45, destaque: fals
{ id: 36, nome: "Blusa Yasmin", cat: "Blusas", sub: "Viscolaycra", preco: 30, destaque: fal
// REGATAS
{ id: 37, nome: "Regata Ellen", cat: "Regatas", sub: "Viscolaycra", preco: 20, destaque: fa
// CARDIGANS
...
// MACACOES
{ id: 3, nome: "Macacao Kami", cat: "Macacoes", sub: "Viscolaycra", preco: 79, destaque: tr
];
const CATS = [
...
<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="curre
<polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="
</svg>
</button>
</div>
))}
...
<svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidt
</div>
...
Adicione mais {6 - totPcs} peca{6 - totPcs > 1 ? "s" : ""} para finalizar — pedido
</div>
)}
{/* Steps */}
...
["cartao", " ", "Cartao de Credito", "Pague na maquininha no ato da ].map(([v, ic, lb, sub, co, bg]) => (
entreg
...
<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColo
...
{/* Grid destaques */}
{cat === "destaques" && (
<div className="fade" style={{ display: "grid", gridTemplateColumns: mob {prods.map((p) => (
